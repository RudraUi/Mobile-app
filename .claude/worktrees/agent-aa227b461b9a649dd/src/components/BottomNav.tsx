...
function HomeIcon({ active }: { active: boolean }) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={active ? "#1558e8" : "#676f88"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
function DroneIcon({ active }: { active: boolean }) {
  ...
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      ...
      <line x1="8" y1="8" x2="10" y2="10" stroke={c} strokeWidth="1.8" strokeLinecap="round" />
      <line x1="16" y1="8" x2="14" y2="10" stroke={c} strokeWidth="1.8" strokeLinecap="round" />
      <line x1="8" y1="16" x2="10" y2="14" stroke={c} strokeWidth="1.8" strokeLinecap="round" />
      <line x1="16" y1="16" x2="14" y2="14" stroke={c} strokeWidth="1.8" strokeLinecap="round" />
