...
export function MapView({
  ...
  return (
    ...
    >
      ...
      <text x="322" y="142" textAnchor="middle" fontSize="8" fill="#9ca3b0" fontFamily="Urbanist" letterSpacing="1">STAIR</text>
      ...
      <text x="98" y="560" textAnchor="middle" fontSize="9" fill="#b0b8cc" fontFamily="Urbanist" letterSpacing="1.5">ZONE E</text>
      ...
      <text x="98" y="745" textAnchor="middle" fontSize="9" fill="#b0b8cc" fontFamily="Urbanist" letterSpacing="1.5">ZONE G</text>

      <rect x="184" y="660" width="170" height="162" rx="2" fill="#fafafa" stroke="#d8dce6" strokeWidth="0.8" strokeDasharray="4 3" />
      <text x="269" y="745" textAnchor="middle" fontSize="9" fill="#b0b8cc" fontFamily="Urbanist" letterSpacing="1.5">ZONE H</text>
      ...
      <text x="197" y="69" textAnchor="middle" fontSize="7.5" fill="#b0b8cc" fontFamily="Urbanist" letterSpacing="0.8">10 000</text>
      ...
      <text x="10" y="460" textAnchor="middle" fontSize="7.5" fill="#b0b8cc" fontFamily="Urbanist" letterSpacing="0.8"
        transform="rotate(-90 10 460)">28 800</text>

      {/* Room labels */}
      <text x="100" y="215" textAnchor="middle" fontSize="8.5" fill="#c4c9d8" fontFamily="Urbanist" fontWeight="600" letterSpacing="1.5">KITCHEN</text>
      <text x="268" y="215" textAnchor="middle" fontSize="8.5" fill="#c4c9d8" fontFamily="Urbanist" fontWeight="600" letterSpacing="1.5">BATHROOM</text>
      <text x="100" y="410" textAnchor="middle" fontSize="8.5" fill="#c4c9d8" fontFamily="Urbanist" fontWeight="600" letterSpacing="1.5">LIVING ROOM</text>
      <text x="268" y="410" textAnchor="middle" fontSize="8.5" fill="#c4c9d8" fontFamily="Urbanist" fontWeight="600" letterSpacing="1.5">OFFICE</text>
      ...
      {items.map((item) => (
        ...
        >
          ...
          <text y="3" textAnchor="middle" fontSize="7" fill="white" fontWeight="bold" fontFamily="Urbanist">
            {typeIcons[item.type]}
          </text>
        </g>
      ))}
