    ...
    >
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        >
          {/* Today */}
          <div
            className="rounded-2xl p-4 shrink-0 flex flex-col gap-2"
            style={{
              width: "140px",
          ...
          <div
            className="rounded-2xl p-4 shrink-0 flex flex-col gap-2"
            style={{ width: "140px", backgroundColor: "#2451FF" }}
          >
            <svg
              width="20"
              height="20"
          ...
          <div
            className="rounded-2xl p-4 shrink-0 flex flex-col gap-2"
            style={{ width: "140px", backgroundColor: "#7C3AED" }}
          >
            <svg
              width="20"
              height="20"
          ...
          <div
            className="rounded-2xl p-4 shrink-0 flex flex-col gap-2"
            style={{ width: "140px", backgroundColor: "#D97706" }}
          >
            <svg
              width="20"
              height="20"
            ...
            {recentItems.map((item) => (
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke={item.severity === "HIGH" ? "#EF4444" : "#2451FF"}
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                >
        ...
        <div className="px-4 mt-4 mb-6">
          ...
          >
            <svg
              ...
              strokeLinejoin="round"
            >
              <path d="M4 20h16a2 2 0 002-2V8l-6-6H6a2 2 0 00-2 2v14a2 2 0 002 2z" />
              <path d="M14 2v6h6" />
            </svg>
            <span
              style={{
