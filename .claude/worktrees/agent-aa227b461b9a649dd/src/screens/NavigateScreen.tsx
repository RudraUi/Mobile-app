...
export function NavigateScreen({
  ...
  const dist = Math.round(
    Math.sqrt(
      Math.pow(item.location.x - 225, 2) + Math.pow(item.location.y - 450, 2),
    ) * 0.3,
  )
  ...
  return (
    ...
    >
      ...
      {/* Info card */}
      <div
        className="mx-4 mt-3 bg-white rounded-2xl px-4 py-3.5 flex items-center gap-3 shrink-0"
      ...
      {arrived && (
        <div
          ...
          style={{ backgroundColor: "rgba(15,20,40,0.5)" }}
        >
          <div
            className="bg-white rounded-t-[2rem] w-full px-5 pt-6 pb-8 animate-slide-up"
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="relative">
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundColor: typeColor,
                      boxShadow: `0 6px 20px ${typeColor}50`,
                    }}
                  >
              ...
              <div
                ...
                style={{
                  ...
                  border: `1.5px solid ${typeColor}20`,
                }}
              >
                <div
