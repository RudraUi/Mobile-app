  ...
  return (
    ...
    >
      <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
        ...
        <path d="M7 9l8 4.5 8-4.5" stroke="white" strokeWidth="2.2" fill="none" strokeLinejoin="round" />
        <path d="M15 13.5v10.5" stroke="white" strokeWidth="2.2" strokeLinecap="round" />
        <path d="M11 11.5v10.5M19 11.5v10.5" stroke="white" strokeWidth="1.2" strokeLinecap="round" opacity="0.5" />
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(180deg, rgba(0,82,255,0.06) 0%, transparent 100%)",
        }}
      />
      ...
      <div className="flex-1 flex flex-col px-7 pt-16 pb-8 overflow-y-auto relative">
        ...
        <div className="mb-10 animate-slide-up">
          ...
          <p className="text-[15px] mt-2 font-medium" style={{ color: "#7c8498" }}>
            Stay updated in the professional BIM world
          </p>
        </div>

        {/* Form */}
        <div className="flex flex-col gap-3.5 animate-slide-up" style={{ animationDelay: "0.05s" }}>
          {/* Email */}
          <div
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={emailFocused || email ? "#0052ff" : "#94a3b8"} strokeWidth="1.8" strokeLinecap="round">
            ...
            />
            {email && (
              <div className="w-5 h-5 rounded-full flex items-center justify-center" style={{ backgroundColor: "#0052ff" }}>
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={passFocused || password ? "#0052ff" : "#94a3b8"} strokeWidth="1.8" strokeLinecap="round">
            ...
            <input
              ...
              className="flex-1 bg-transparent text-[15px] font-medium outline-none"
              style={{ color: "#1a1f36", fontFamily: password && !showPassword ? "inherit" : "Urbanist, sans-serif" }}
            />
            <button
        ...
        >
          <span className="text-[14px] font-semibold" style={{ color: "#0052ff" }}>
