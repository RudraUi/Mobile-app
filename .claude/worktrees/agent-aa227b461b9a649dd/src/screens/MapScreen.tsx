      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        >
          ...
          {filteredItems.map((item) => {
            const pos = PIN_POSITIONS[item.id] || {
              x: 150 + (item.location.x % 100),
              y: 200 + (item.location.y % 300),
            }
            ...
            return (
              ...
              >
                ...
                <path
                  d="M0,-18 C-8,-18 -12,-10 -12,-5 C-12,3 0,12 0,12 C0,12 12,3 12,-5 C12,-10 8,-18 0,-18 Z"
                  fill={color}
                />
                <text
                  y="-3"
