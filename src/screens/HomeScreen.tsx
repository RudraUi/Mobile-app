...
function StatIcon({ id, color = "#ffffff" }: { id: string color?: string }) {
  ...
  if (id === "in-review") {
    return (
      <svg width="13" height="13" viewBox="0 0 16 16" fill="none">
        <path
          d="M1.5 8S4 4.2 8 4.2s6.5 3.8 6.5 3.8-2.5 3.8-6.5 3.8S1.5 8 1.5 8Z"
          stroke={color}
          strokeWidth="1.5"
          strokeLinejoin="round"
        />
...
function ChecklistIcon() {
  return (
    ...
    >
      <path
        d="m1.7 5 1.3 1.3 2.1-2.1M1.7 10 3 11.3l2.1-2.1M1.7 15 3 16.3l2.1-2.1"
        stroke="#475569"
        strokeWidth="1.45"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M7.2 5.3h9M7.2 10.3h9M7.2 15.3h9"
        stroke="#475569"
        strokeWidth="1.45"
        strokeLinecap="round"
      />
...
function PhaseIcon() {
  return (
    ...
    >
      ...
      />
      <path
        d="M8.2 5.2h8M8.2 10h8M8.2 14.8h8"
        stroke="#475569"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
    ...
    <div className="flex h-full min-h-0 flex-col bg-[#0055ff] text-[#18243D]">
      ...
      >
        ...
        {isRefreshing ? (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5 flex-wrap">
                <span className="text-[13px] font-bold text-slate-700">
                  ...
                  {filteredWorkItems.length === 1 ? "result" : "results"} found
                </span>
                {searchQuery && (
          ...
          <div
            key={selectedProject.id + markupFilter}
            className="animate-fade-in flex flex-col flex-1 min-h-full bg-[#0055ff]"
          >
            ...
            <div className="rounded-t-[30px] bg-white pt-5 pb-8 shadow-[0_-10px_35px_rgba(0,0,0,0.08)] flex-1 min-h-full flex flex-col -mt-3 z-10 relative">
              ...
              <section className="px-4" aria-labelledby="recents-heading">
                <div
                  id="recents-heading"
                  className="flex h-[32px] w-full items-center justify-between px-1 mb-1"
                >
                  <div className="flex items-center gap-2">
                  ...
                  {currentConfig.recentRows.map((row) => {
                    ...
                    const itemToOpen = matchingItem || {
                      ...
                      location: {
                        x: 200,
                        y: 300,
                        label: `${selectedProject.name}, ${selectedProject.location}`,
                      },
                      photos: [],
                      activity: [
                        {
                          id: "init",
                          text: "Logged in field",
                          date: "01 Sep 2026",
                        },
                      ],
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 ${getItemTypeColors(row.type)}`}
                        >
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          ...
                          <span className="text-slate-300 group-hover:text-slate-500 transition-colors text-[13px] font-bold">
                            ›
                          </span>
                        </div>
                      </button>
              ...
              >
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11px] font-medium text-slate-400 mt-0.5">
                      Active deliverables & punch lists
                    </p>
                  </div>
                  <div className="flex items-center gap-1.5 shrink-0">
