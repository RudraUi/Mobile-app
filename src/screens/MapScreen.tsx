  ...
  return (
    <div className="flex flex-col h-full bg-[#f6f7f9] select-none overflow-hidden">
      ...
      <div className="flex-1 relative overflow-hidden bg-[#E5E9F0]">
        ...
        >
          <svg viewBox="0 0 430 750" className="w-full h-full" style={{ background: "#EDF1F7" }}>
              <defs>
                <pattern id="mapGrid" width="30" height="30" patternUnits="userSpaceOnUse">
                  <path d="M 30 0 L 0 0 0 30" fill="none" stroke="#DCE2EC" strokeWidth="0.8" />
                </pattern>
              </defs>
              ...
              {/* Road names */}
              <text x="215" y="103" textAnchor="middle" fontSize="9.5" fill="#8A99AD" fontWeight="600" fontFamily="sans-serif" letterSpacing="0.8">WEST HIGHLAND AVE</text>
              <text x="215" y="346" textAnchor="middle" fontSize="10" fill="#8A99AD" fontWeight="600" fontFamily="sans-serif" letterSpacing="0.8">METRO BOULEVARD</text>
              <text x="215" y="603" textAnchor="middle" fontSize="9.5" fill="#8A99AD" fontWeight="600" fontFamily="sans-serif" letterSpacing="0.8">HARBOR STREET</text>

              {/* Surrounding City Blocks */}
              <rect x="12" y="12" width="56" height="56" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />
              <rect x="130" y="12" width="158" height="56" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />
              <rect x="350" y="12" width="68" height="56" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />

              <rect x="12" y="128" width="56" height="180" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />
              <rect x="350" y="128" width="68" height="180" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />

              <rect x="12" y="374" width="56" height="194" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />
              <rect x="350" y="374" width="68" height="194" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />

              <rect x="12" y="628" width="56" height="100" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />
              <rect x="130" y="628" width="158" height="100" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />
              <rect x="350" y="628" width="68" height="100" rx="4" fill="white" stroke="#CAD3E2" strokeWidth="1.2" />

              {/* ACTIVE PROJECT CONSTRUCTION SITE (Center Zone) */}
              {/* Site Boundary dashed line */}
              <rect x="128" y="126" width="162" height="184" rx="6" fill="#EEF7F4" stroke="#0D9488" strokeWidth="2" strokeDasharray="6 4" />
              
              {/* Tower Crane Arc */}
              <circle cx="209" cy="218" r="64" fill="none" stroke="#0D9488" strokeWidth="1" strokeDasharray="3 3" opacity="0.6" />
              <circle cx="209" cy="218" r="3" fill="#0D9488" />
              <line x1="209" y1="218" x2="260" y2="180" stroke="#0D9488" strokeWidth="1.5" />

              {/* Building Footprint (Core) */}
              <rect x="148" y="156" width="122" height="124" rx="3" fill="white" stroke="#0D9488" strokeWidth="1.5" />
              <text x="209" y="214" textAnchor="middle" fontSize="10.5" fill="#0F766E" fontWeight="700" fontFamily="sans-serif">{selectedProject.name.toUpperCase()}</text>
              <text x="209" y="228" textAnchor="middle" fontSize="8" fill="#14B8A6" fontWeight="600" fontFamily="sans-serif">ZONE A · LEVEL 02 IN PROGRESS</text>

              {/* Site Gate Marker */}
              <rect x="128" y="196" width="6" height="24" fill="#0D9488" rx="2" />
              <text x="120" y="212" textAnchor="end" fontSize="7.5" fill="#0F766E" fontWeight="bold">GATE 1</text>
              ...
              <circle cx="178" cy="254" r="4.5" fill="#0055ff" stroke="white" strokeWidth="1.5" />
            </svg>
        ...
        <div className="absolute top-3.5 right-3.5 z-20 flex flex-col gap-1.5">
          ...
          <div className="w-8 h-8 rounded-xl bg-white/95 backdrop-blur-md text-slate-700 flex items-center justify-center shadow-md shadow-black/10 border border-slate-200/80">
            <div className="flex flex-col items-center">
              <span className="text-[7.5px] font-extrabold text-red-500 leading-none">N</span>
