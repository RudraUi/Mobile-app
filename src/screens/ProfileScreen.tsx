    ...
    <div className="relative flex flex-col h-full bg-white select-none overflow-hidden text-slate-900">
      ...
      <main className="flex-1 overflow-y-auto px-5 py-5 space-y-6">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {/* Name & Subtitle */}
          <h2 className="text-[17px] font-bold text-slate-900 mt-2.5 tracking-tight">
            {formData.name}
          </h2>
          <p className="text-[12.5px] text-slate-500 font-medium mt-0.5">
            {formData.role} ·{" "}
            <span className="text-slate-700">{formData.organization}</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 py-3 border-y border-slate-100">
          ...
          <div className="text-center">
            <div className="text-[17px] font-bold text-emerald-600 tracking-tight">
              98%
            </div>
            <div className="text-[10.5px] font-medium text-slate-400 mt-0.5">
              On-time Score
        ...
        <div className="space-y-4">
          ...
          <div className="divide-y divide-slate-100 bg-slate-50/60 rounded-2xl border border-slate-100/80 px-4">
            ...
            <div className="py-2.5 flex items-center justify-between gap-3">
              <label className="text-[12.5px] font-medium text-slate-500 shrink-0 w-28">
                Full Name
              </label>
              <input
                type="text"
