...
const filters = [
  ...
  },
  {
    ...
    label: "RFI",
    icon: (
      <svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" strokeLinecap="round" aria-hidden="true">
...
export function AppHeader({
  ...
  return (
    <header className="home-header shrink-0 text-white shadow-md relative z-40">
      ...
      {/* Modern Capsule Navigation Tabs with Equal Size and Proper Padding */}
        ...
        {filters.map((filter) => {
          ...
          return (
            <button
              ...
              className={`flex shrink-0 items-center gap-[4.5px] rounded-full px-2.5 py-[4.5px] text-[10.5px] font-bold leading-none transition-all duration-150 cursor-pointer active:scale-95 ${
                isActive
            ...
            >
              <span className={`h-[13px] w-[13px] flex items-center justify-center shrink-0 ${isActive ? "text-[#0055ff]" : "text-white"}`}>
                {filter.icon}
              </span>
