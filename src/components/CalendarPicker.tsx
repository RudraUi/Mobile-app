...
export function CalendarPicker({ value, onChange, color = "#0052ff" }: CalendarPickerProps) {
    ...
    >
      ...
      <div
        style={{
          ...
          animation: "calSheetIn 240ms cubic-bezier(0.34,1.1,0.64,1) forwards",
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "center", paddingTop: "12px", paddingBottom: "4px" }}>
          <div style={{ width: "36px", height: "4px", borderRadius: "99px", background: "#e0e7f0" }} />
        </div>
        ...
        <div style={{ padding: "12px 20px 0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            ...
            <p style={{ fontSize: "20px", fontWeight: 800, color: "#1a1f36", lineHeight: 1.2 }}>
          ...
          <button
            ...
            style={{
              ...
              background: "#f4f7ff", border: "none", cursor: "pointer",
        ...
        <div style={{ padding: "16px 20px 8px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M10 4L6 8L10 12" stroke="#1a1f36" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <span style={{ fontSize: "16px", fontWeight: 400, color: "#94a3b8", marginLeft: "6px" }}>
              {year}
            </span>
          </div>
          ...
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M6 4L10 8L6 12" stroke="#1a1f36" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
        </div>
        ...
        {/* Days grid */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", padding: "0 16px 8px", gap: "2px 0" }}>
          {cells.map((day, idx) => {
            ...
            let bg = "transparent";
            let txtColor = isPast ? "#c8d1e0" : isWeekend ? "#e2a0a0" : "#1a1f36";
        ...
        <div style={{ padding: "8px 20px 16px", display: "flex", gap: "10px" }}>
          <button
            ...
            style={{
              ...
              border: "2px solid #e8eeff", background: "white",
          ...
          <button
            ...
            style={{
              ...
              border: "none", background: value ? color : "#e8eeff",
    ...
    <>
      ...
      >
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ flexShrink: 0 }}>
          <rect x="1" y="3" width="14" height="12" rx="2" stroke={value ? color : "#94a3b8"} strokeWidth="1.5" />
          <path d="M5 1v4M11 1v4" stroke={value ? color : "#94a3b8"} strokeWidth="1.5" strokeLinecap="round" />
          <path d="M1 7h14" stroke={value ? color : "#94a3b8"} strokeWidth="1.5" />
        </svg>
        <span style={{ flex: 1, fontSize: "14px", fontWeight: 600, color: value ? "#1a1f36" : "#94a3b8" }}>
